...
headers = {'User-Agent': 'MMozilla/5.0 (Windows NT 10.0; WOW64; rv:53.0) Gecko/20100101 Firefox/53.0',
           "Host": "www.zhihu.com",
...
def login(username, password):
    ...
    print("json.loads(results): %s" % json.loads(results))
